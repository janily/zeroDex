export const poolManagerAbi = [
  ...
  "function getAllPools() view returns (tuple(address token0,address token1,uint256 index,uint24 fee,int24 tickLower,int24 tickUpper,int24 tick,uint160 sqrtPriceX96,uint128 liquidity)[])",
